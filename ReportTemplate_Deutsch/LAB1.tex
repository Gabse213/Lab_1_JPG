...
\def\lecture{Wissenschaftliches Arbeiten}
\def\codeStudydegreeyear{MGST-B-1-WSMI-WS-ILV}
\def\subtitle{Aufgabe 3: Formalkriterien Laborreport}
...
%\clearpage
	...
	\input{sections/1-introduction.tex} % have a look inside the tex files regarding  the sections. Here they are only added one after another
